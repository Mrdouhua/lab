				...
				<div className="main-wrap">
					...
					<div className="container">
						<div className="content">
							<div className="items">
								<h2 className="items-tit">标题</h2>
								<div className="items-con">{this.state.data}</div>
							</div>
						</div>
						<div className="page-container">
							<div className="page">
								<span className="start">首页</span>
								<span className='prev'>上一页</span>
								<ul className="pageNum"></ul>
								<span className='next'>下一页</span>
								<span className="last">尾页</span>
								<div className='allNum'>共{this.state.pageNum}页</div>
							</div>
						</div>
					</div>
				</div>
